...
<div class="grid grid-cols-1 lg:grid-cols-4 gap-4">
    ...
    <div class="lg:col-span-1">
        <div class="bg-white rounded border border-slate-200 shadow-sm p-4 sticky top-4">
            ...
            <form action="{{ url('/app/data-kelas') }}" method="POST" class="space-y-3">
                @csrf
                <div>
                    ...
                    <tbody>
                        ...
                        <tr class="hover:bg-slate-50">
                            ...
                            <td class="text-center">
                                <form action="{{ url('/app/data-kelas', $k->id) }}" method="POST" onsubmit="return confirm('Menghapus kelas akan menghapus seluruh data siswa di dalamnya beserta nilai dan absensi mereka! Yakin?');">
                                    @csrf
                                    @method('DELETE')
