    ...
    <div :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" 
        ...
        <nav class="flex-1 overflow-y-auto overscroll-contain touch-pan-y py-4 px-3 space-y-6 sidebar-scroll pb-24">
            ...
            <div>
                ...
                <div class="space-y-1">
                    <a href="{{ url('/app/dashboard-admin') }}" class="flex items-center gap-3 px-3 py-3 rounded-xl text-sm font-medium {{ request()->is('app/dashboard-admin') ? 'bg-blue-950/50 text-white relative before:absolute before:left-0 before:top-2 before:bottom-2 before:w-1.5 before:bg-blue-400 before:rounded-r-full shadow-inner' : 'text-blue-100 hover:bg-white/10 hover:text-white' }} transition-all min-h-[44px]">
            ...
            <!-- Master Data Admin -->
            <div>
                <p class="px-3 text-xs font-semibold text-blue-300 uppercase tracking-wider mb-2">Manajemen Pengguna</p>
                <div class="space-y-1">
                    <a href="{{ url('/app/admin/data-guru') }}" class="flex items-center gap-3 px-3 py-3 rounded-xl text-sm font-medium {{ request()->is('app/admin/data-guru*') ? 'bg-blue-950/50 text-white relative before:absolute before:left-0 before:top-2 before:bottom-2 before:w-1.5 before:bg-blue-400 before:rounded-r-full shadow-inner' : 'text-blue-100 hover:bg-white/10 hover:text-white' }} transition-all min-h-[44px]">
                    ...
                    <a href="{{ url('/app/admin/data-kelas') }}" class="flex items-center gap-3 px-3 py-3 rounded-xl text-sm font-medium {{ request()->is('app/admin/data-kelas*') ? 'bg-blue-950/50 text-white relative before:absolute before:left-0 before:top-2 before:bottom-2 before:w-1.5 before:bg-blue-400 before:rounded-r-full shadow-inner' : 'text-blue-100 hover:bg-white/10 hover:text-white' }} transition-all min-h-[44px]">
                    ...
                    <a href="{{ url('/app/admin/data-siswa') }}" class="flex items-center gap-3 px-3 py-3 rounded-xl text-sm font-medium {{ request()->is('app/admin/data-siswa*') ? 'bg-blue-950/50 text-white relative before:absolute before:left-0 before:top-2 before:bottom-2 before:w-1.5 before:bg-blue-400 before:rounded-r-full shadow-inner' : 'text-blue-100 hover:bg-white/10 hover:text-white' }} transition-all min-h-[44px]">
            ...
            <!-- Pengaturan Admin -->
            <div>
                <p class="px-3 text-xs font-semibold text-blue-300 uppercase tracking-wider mb-2">Moderasi & Pengaturan</p>
                <div class="space-y-1">
                    <a href="{{ url('/app/admin/kelola-komentar') }}" class="flex items-center gap-3 px-3 py-3 rounded-xl text-sm font-medium {{ request()->is('app/admin/kelola-komentar*') ? 'bg-blue-950/50 text-white relative before:absolute before:left-0 before:top-2 before:bottom-2 before:w-1.5 before:bg-blue-400 before:rounded-r-full shadow-inner' : 'text-blue-100 hover:bg-white/10 hover:text-white' }} transition-all min-h-[44px]">
                    ...
                    <a href="{{ url('/app/admin/artikel') }}" class="flex items-center gap-3 px-3 py-3 rounded-xl text-sm font-medium {{ request()->is('app/admin/artikel*') ? 'bg-blue-950/50 text-white relative before:absolute before:left-0 before:top-2 before:bottom-2 before:w-1.5 before:bg-blue-400 before:rounded-r-full shadow-inner' : 'text-blue-100 hover:bg-white/10 hover:text-white' }} transition-all min-h-[44px]">
            ...
            <!-- Laporan -->
            <div>
                <p class="px-3 text-xs font-semibold text-blue-300 uppercase tracking-wider mb-2">Laporan Akademik</p>
                <div class="space-y-1">
                    <!-- Dropdown Laporan -->
            ...
            <div>
                ...
                <div class="space-y-1">
                    ...
                    <a href="{{ url('/app/tugas-siswa') }}" class="flex items-center gap-3 px-3 py-3 rounded-xl text-sm font-medium {{ request()->is('app/tugas-siswa*') || request()->is('app/materi-siswa*') ? 'bg-blue-950/50 text-white relative before:absolute before:left-0 before:top-2 before:bottom-2 before:w-1.5 before:bg-blue-400 before:rounded-r-full shadow-inner' : 'text-blue-100 hover:bg-white/10 hover:text-white' }} transition-all min-h-[44px]">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path></svg>
                        Tugas
                    </a>
